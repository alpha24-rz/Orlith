...
class DeepResearchMode(BaseReasoningMode):
    ...
    async def _write_final_report(
        ...
        system_instruction = (
            ...
            "1. Jika memberikan data komparatif, terstruktur, atau statistik, gunakan Markdown Table.\n"
            "2. Jika memberikan contoh skrip, konfigurasi, atau log, gunakan Markdown Code Blocks (```language ... ```).\n\n"
