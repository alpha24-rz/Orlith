...
class DeepResearchMode(BaseReasoningMode):
    ...
    async def _write_final_report(
        ...
        system_instruction = (
            ...
            "1. Jika menulis rumus matematika, persamaan, atau model statistik, WAJIB gunakan LaTeX ($inline$ dan $$block$$).\n"
            "2. Jika memberikan data komparatif, terstruktur, atau statistik, WAJIB gunakan GitHub Flavored Markdown (GFM) Table (| Header | ... |).\n"
            "3. Jika memberikan contoh skrip, konfigurasi, atau log, WAJIB gunakan Markdown Code Blocks (```language ... ```) dengan identasi rapi.\n\n"
