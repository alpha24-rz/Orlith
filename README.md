...
**Linux and macOS:**
```bash
curl -sSL https://raw.githubusercontent.com/yourusername/orlith/main/install.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/yourusername/orlith/main/install.ps1 | iex
```
